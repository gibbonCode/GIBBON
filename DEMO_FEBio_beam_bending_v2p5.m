...
FEB_struct.febio_spec.version='2.5';
...
% %% TEST STUFF FOR FEBIO SPEC 2.5
% 
% %Define element sets
% FEB_struct.Geometry.ElementSet{1}.Set=1:10;
% FEB_struct.Geometry.ElementSet{1}.Name='elemSet1';
% 
% FEB_struct.Geometry.ElementSet{2}.Set=11:15;
% FEB_struct.Geometry.ElementSet{2}.Name='elemSet2dfsa';
% 
% FEB_struct.Geometry.MeshData.ElementData{1}.Var='shell thickness';
% FEB_struct.Geometry.MeshData.ElementData{1}.SetName=FEB_struct.Geometry.ElementSet{1}.Name;
% FEB_struct.Geometry.MeshData.ElementData{1}.Val=[pi*ones(5,4)];
% 
% FEB_struct.Geometry.MeshData.ElementData{2}.Var='SDAFAS';
% FEB_struct.Geometry.MeshData.ElementData{2}.SetName=FEB_struct.Geometry.ElementSet{2}.Name;
% FEB_struct.Geometry.MeshData.ElementData{2}.Val=[2*pi*ones(8,2)];
% 

FEB_struct.Geometry.MeshData.NodeData{1}.Var='nodal force x';
FEB_struct.Geometry.MeshData.NodeData{1}.SetName=FEB_struct.Geometry.NodeSet{2}.Name;
FEB_struct.Geometry.MeshData.NodeData{1}.Val=bcPrescribeMagnitudes(:,1);

FEB_struct.Geometry.MeshData.NodeData{2}.Var='nodal force y';
FEB_struct.Geometry.MeshData.NodeData{2}.SetName=FEB_struct.Geometry.NodeSet{2}.Name;
FEB_struct.Geometry.MeshData.NodeData{2}.Val=bcPrescribeMagnitudes(:,2);

FEB_struct.Geometry.MeshData.NodeData{3}.Var='nodal force z';
FEB_struct.Geometry.MeshData.NodeData{3}.SetName=FEB_struct.Geometry.NodeSet{2}.Name;
FEB_struct.Geometry.MeshData.NodeData{3}.Val=bcPrescribeMagnitudes(:,3);

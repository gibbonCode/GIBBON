%% DEMO_FEBio_iFEA_uniaxial_transiso_02.m
...
FEB_struct.Materials{1}.Solid{3}.Type='ellipsoidal fiber distribution';
FEB_struct.Materials{1}.Solid{3}.Properties={'ksi','beta'};
FEB_struct.Materials{1}.Solid{3}.Values={[ksi_ini ksi_ini f_ini*ksi_ini],[beta_ini beta_ini beta_ini]};
FEB_struct.Materials{1}.Solid{3}.AnisoType='mat_axis';
    ...
    switch objectiveStruct.method
        case 1 %fminsearch and Nelder-Mead
            ...
            OPT_options = optimset(OPT_options,'MaxFunEvals',maxNumberFunctionEvaluations,...
                ...
                'FinDiffRelStep',0.01,...
                'DiffMaxChange',0.5);
            [Pn_opt,OPT_out.fval,OPT_out.exitflag,OPT_out.output]= fminsearch(@(Pn) obj_DEMO_FEBio_iFEA_uniaxial_transiso_02(Pn,objectiveStruct),Pn,OPT_options);
        case 2 %lsqnonlin and Levenberg-Marquardt
            ...
            OPT_options = optimoptions(OPT_options,'MaxFunEvals',maxNumberFunctionEvaluations,...
                ...
                'FinDiffRelStep',0.01,...
                'DiffMaxChange',0.5);
            [Pn_opt,OPT_out.resnorm,OPT_out.residual]= lsqnonlin(@(Pn) obj_DEMO_FEBio_iFEA_uniaxial_transiso_02(Pn,objectiveStruct),Pn,[],[],OPT_options);
    end
...
[Fopt,OPT_stats_out]=obj_DEMO_FEBio_iFEA_uniaxial_transiso_02(Pn,objectiveStruct);

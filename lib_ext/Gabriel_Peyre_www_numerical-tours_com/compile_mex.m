...
% Kevin-Mattheus-Moerman note: 
% I implemented a fix based on this thread
% https://stackoverflow.com/questions/43045701/switch-compiler-on-matlab-2017a-in-ubuntu-os

%% Set current directory
defaultFolder = fileparts(mfilename('fullpath'));
mexPath=fullfile(defaultFolder,'mex');
cd(mexPath);

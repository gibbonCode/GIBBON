...
% 2) The use of multiple steps where contact is switched on and off
% depending on step
...
FEB_struct.Step{3}.Control.Values={20,0.05,...
    25,0,...
    0.001,0.01,0,0.9};
FEB_struct.Step{3}.Control.TimeStepperValues={1e-4,0.05,5,5,1};
...
FEB_struct.Step{3}.Contact{1}.Surface{1}.SetName=FEB_struct.Geometry.Surface{1}.Name;
FEB_struct.Step{3}.Contact{1}.Surface{1}.Type='master';

FEB_struct.Step{3}.Contact{1}.Surface{2}.SetName=FEB_struct.Geometry.Surface{2}.Name;
FEB_struct.Step{3}.Contact{1}.Surface{2}.Type='slave';

FEB_struct.Step{3}.Contact{1}.Type='sliding_with_gaps';
FEB_struct.Step{3}.Contact{1}.Properties={'penalty','auto_penalty','two_pass',...
                                          'laugon','tolerance',...
                                          'gaptol','minaug','maxaug',...
                                          'fric_coeff','fric_penalty',...
                                          'seg_up',...
                                          'search_tol'};
FEB_struct.Step{3}.Contact{1}.Values={100,1,0,...
                                      0,0.1,...
                                      0,0,10,...
                                      0,1,...
                                      0,...
...
FEB_struct.LoadData.LoadCurves.loadPoints={[0 0;1 1];[0 0; 1 1; 2 0; 3 1];};

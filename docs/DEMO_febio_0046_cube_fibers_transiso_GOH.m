%% DEMO_febio_0046_cube_fibers_transiso_GOH
...
vecSizeNow=mean(patchEdgeLengths(Fb,V));
...
[h]=quiverVec(VE,V_fib,vecSizeNow*0.9,'k');
[h]=quiverVec(VE,a,vecSizeNow/2,'r');
[h]=quiverVec(VE,d,vecSizeNow/2,'g');
...
%Material section
febio_spec.Material.material{1}.ATTR.type='Gasser-Ogden-Holzapfel-uncoupled';
...
febio_spec.Material.material{1}.density=densityVal;
...
if runFlag==1 %i.e. a succesful run
    ...
    xlabel('\lambda Stretch [.]','FontSize',fontSize); ylabel('\sigma Cauchy stress [Pa]','FontSize',fontSize); 

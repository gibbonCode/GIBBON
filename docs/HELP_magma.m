%% magma
% Below is a demonstration of the features of the |magma| function
...
cMap=magma(250); %Get 25 color levels from the colormap
...
%%
cFigure; hold on;
title('magma colormap','FontSize',fontSize);
imagesc(Z);

...
Vg=gaborCoil(V,[1 2],numStepsSweep,4,20,4);
[Vg] = evenlySampleCurve(Vg,size(Vg,1),'linear',0);

n1=[0 0 1];
n2=[0 0 1];
% 
% % R=euler2DCM(2*pi*randn(1,3));
% R=euler2DCM([0.1*pi 0 0]);
% % R=[-0.0279455357440037,0.502222010667919,-0.864287046664853;0.959364162539487,0.256342396246946,0.117936336729962;0.280783636750594,-0.825870224603749,-0.488977424270348];
% V1=V1*R;
% V2=V2*R;
% n1=n1*R;
% n2=n2*R;
...
[F,V,C]=sweepLoft(V1,V2,n1,n2,Vg,numStepsSweep,numTwist,1);

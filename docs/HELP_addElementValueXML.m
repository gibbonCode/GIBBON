%% addElementValueXML
% Below is a demonstration of the features of the |addElementValueXML| function

%%
clear; close all; clc;

%% Syntax
% |[domNode]=addElementValueXML(domNode,elementNode,elementValue);|

%% Description 
% This function adds an element value (|elementValue| to the previously
% defined element at |elementNode| of an XML object |domNode|. 
...
elementName='c';
[domNode]=addElementXML(domNode,subElementNode,elementName,[]);

% Add element value
elementValue=2;
subSubElementNode=domNode.getElementsByTagName(elementName).item(0);
[domNode]=addElementValueXML(domNode,subSubElementNode,elementValue);

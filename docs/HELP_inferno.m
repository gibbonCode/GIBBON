%% inferno
% Below is a demonstration of the features of the |inferno| function
...
cMap=inferno(250); %Get 25 color levels from the colormap
...
%%
cFigure; hold on;
title('inferno colormap','FontSize',fontSize);
imagesc(Z);

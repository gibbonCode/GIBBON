%% fireice
% Below is a demonstration of the features of the |fireice| function
...
cMap=fireice(250); %Get 25 color levels from the colormap
...
%%
cFigure; hold on;
title('fireice colormap','FontSize',fontSize);
imagesc(Z);

%% grayjet
% Below is a demonstration of the features of the |grayjet| function
...
cMap=grayjet(250); %Get 25 color levels from the colormap
...
%%
cFigure; hold on;
title('grayjet colormap','FontSize',fontSize);
imagesc(Z);

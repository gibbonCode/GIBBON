...
SavePath=fullfile(defaultFolder,'2021_Nataliya_Perevoshchikova_wrist_project','data_triplane','motion');
%SavePath_FILT=fullfile(defaultFolder,'MATLAB','MTP','Data','Brown_University','FILT');
%% Tracked Files
tracked_folder = fullfile(defaultFolder,'2021_Nataliya_Perevoshchikova_wrist_project','data_triplane','Tracked_Files');
...
models_folder = fullfile(defaultFolder,'2021_Nataliya_Perevoshchikova_wrist_project','data_triplane','ACS_Models');
...
tform_folder = fullfile(defaultFolder,'2021_Nataliya_Perevoshchikova_wrist_project','data_triplane','Cropped2ACS_TFM');
